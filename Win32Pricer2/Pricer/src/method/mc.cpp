...
MonteCarlo::MonteCarlo(double *spot_, double *sigma_, double rho_, Taux* r_, int size_, double *trend, TauxDeChange *fx, int numberAssetEuro, int numberAssetDollar,
	...
	const int timeStepSubscription_, double h_, int H_, int samples_) : Method(spot_, sigma_, rho_, r_, size_, trend, fx, numberAssetEuro, numberAssetDollar,
	numberAssetYuan, pastData, T_, timeSteps_, valeurLiquidativeOrigine_, subscriptionPeriod_,
	timeStepSubscription_, h_, H_, samples_){}
