...
TauxDeChange::TauxDeChange(){
	...
	this->txZcEuro = pnl_vect_create_from_file("../zcEUR.csv");
	this->txZcDollar = pnl_vect_create_from_file("../data/zcUSD.csv");
	this->txZcYuan = pnl_vect_create_from_file("../data/zcCNY.csv");

	this->txZcEuro = pnl_vect_create_from_double(23, 0.3);
	this->txZcDollar = pnl_vect_create_from_double(23, 0.3);
	this->txZcYuan = pnl_vect_create_from_double(23, 0.3);
